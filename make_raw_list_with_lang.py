...
if __name__ == '__main__':
    ...
    parser.add_argument('--lang', default=None, help='set lang')
        ...
        for line in fin:
            ...
            if args.lang is None:
                ...
                if args.segments is None:
                    assert key in wav_table
                    wav = wav_table[key]
                    line = dict(key=key, wav=wav, txt=txt,lang=args.lang)
                else:
                    
                    assert key in segments_table
                    wav_key, start, end = segments_table[key]
                    wav = wav_table[wav_key]
                    line = dict(key=key, wav=wav, txt=txt, start=start, end=end,lang=args.lang)
